...
class SettingViewController: UIViewController, SetTopbar {
    ...
    init(nameTag: String, dyteMobileClient: DyteMobileClient, completion:(()->Void)? = nil) {
        ...
        selfPeerView = DyteParticipantTileView(viewModel: VideoPeerViewModel(mobileClient: dyteMobileClient, showScreenShareVideo: false, participant: dyteMobileClient.localUser, showSelfPreviewVideo: true))
