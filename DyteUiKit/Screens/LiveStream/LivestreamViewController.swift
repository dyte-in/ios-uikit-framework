...
public class LivestreamViewController: UIViewController {
    ...
    private var bottomBar: DyteTabbarBar!
    ...
    private var liveButtonBottomBar: DyteControlBarButton?
    ...
    init(dyteMobileClient: DyteMobileClient, completion:@escaping()->Void) {
        self.pluginView = PluginView(videoPeerViewModel:VideoPeerViewModel(mobileClient: dyteMobileClient, showScreenShareVideo: true, participant: dyteMobileClient.localUser, showSelfPreviewVideo: false))
...
//            [unowned self] in
//            return DyteParticipantTileView(mobileClient: self.dyteMobileClient)
//        })
...
//        gridView.set(.fillSuperView(gridBaseView))
    ...
    private func createBottomBar() {
        ...
        let endCallButton = DyteEndMeetingControlBarButton(meeting: dyteMobileClient, alertViewController: self) { buttons, alertButton in
...
extension LivestreamViewController {
    ...
    @objc func clickFlipCamera(button: DyteControlBarButton) {
    ...
    @objc func clickMore(button: DyteControlBarButton) {
        self.moreButtonBottomBar?.notificationBadge.isHidden = true
        createMoreMenu()
    }
    
    @objc func clickLive(button: DyteControlBarButton) {
...
//        }
    ...
    private func move(gridView:  GridView<DyteParticipantTileContainerView>, toView: UIView) {
