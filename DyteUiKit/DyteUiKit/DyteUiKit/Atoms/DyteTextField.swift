...
fileprivate class DyteCustomTextField : UITextField {
...
public class DyteTextField: BaseAtomView {
    ...
    fileprivate  let textField: DyteCustomTextField = {
        let textField = DyteCustomTextField(insetPoint: CGPoint(x: 10, y: 10))
