...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnRoomMessage")))
@interface DOSCDyteEventTypeOnRoomMessage : DOSCDyteEventType
- (instancetype)initWithType:(NSString *)type payload:(NSDictionary<NSString *, id> *)payload __attribute__((swift_name("init(type:payload:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSDictionary<NSString *, id> *payload __attribute__((swift_name("payload")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendMessagePayload:(DOSCKotlinx_serialization_jsonJsonElement * _Nullable)payload completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendMessage(payload:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendPacketPayload:(DOSCKotlinx_serialization_jsonJsonElement * _Nullable)payload completionHandler:(void (^)(DOSCResult<NSString *, DOSCDyteError *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendPacket(payload:completionHandler:)")));
@end
