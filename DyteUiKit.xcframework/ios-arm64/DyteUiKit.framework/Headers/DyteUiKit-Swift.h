...
@interface DyteControlBar : UIView
...
- (void)onScreenShareEndedParticipant:(DOSCDyteScreenShareMeetingParticipant * _Nonnull)participant;
- (void)onScreenShareStartedParticipant:(DOSCDyteScreenShareMeetingParticipant * _Nonnull)participant;
